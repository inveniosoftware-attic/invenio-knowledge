...
sys.path.append(os.path.abspath('../invenio_knowledge'))
...
with open(os.path.join('..', 'invenio_knowledge', 'version.py'), 'rt') as f:
    version = re.search(
        '__version__\s*=\s*"(?P<version>.*)"\n',
        f.read()
    ).group('version')

# The full version, including alpha/beta/rc knowledge.
release = version
...
htmlhelp_basename = 'InvenioKnowledgedoc'
...
latex_documents = [
    ('index', 'InvenioKnowledge.tex', u'Invenio Knowledge Documentation',
...
man_pages = [
    ('index', 'invenioknowledge', u'Invenio Knowledge Documentation',
...
texinfo_documents = [
    ('index', 'Invenio Knowledge', u'Invenio Knowledge Documentation',
     u'Invenio collaboration', 'Invenio Knowledge',
